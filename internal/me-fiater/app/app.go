...
import (
	...
	"github.com/yusupovanton/moneyExchange/internal/me-fiater/service"
)

type application struct {
	db             *sqlx.DB
	config         *AppConfig
	service        *service.FiaterService
...
func New(ctx context.Context, config *AppConfig) *application {
	...
	newApp.service = service.NewFiaterService(newApp.db, newApp.ctx)
	newApp.initParser()
	return &newApp
}
